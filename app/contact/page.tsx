            ...
            <div className="lg:col-span-4 space-y-12">
              ...
              <FadeIn delay={0.4} direction="right">
                <div className="structural-border bg-bg/50 p-8">
                  ...
                  <a href="mailto:thegijuhan@gmail.com" className="font-[family-name:var(--font-shippori)] text-3xl font-bold text-text leading-tight mb-2 hover:text-gold transition-colors block">
              ...
              <FadeIn delay={0.5} direction="right">
                <div className="structural-border bg-bg/50 p-8">
                  <div className="flex items-center gap-4 mb-6 text-gold">
                    <Clock size={24} />
                    <h3 className="font-[family-name:var(--font-syne)] text-[10px] tracking-[0.3em] font-bold uppercase">Availability</h3>
                  </div>
                  <p className="font-[family-name:var(--font-shippori)] text-3xl font-bold text-text leading-tight mb-2">
                    Mon – Fri
                  </p>
